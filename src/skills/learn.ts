...
export const learnSkillName = "conductor-learn"
...
export async function installLearnSkill(root: string) {
  const dir = join(root, ".conductor", "skills", learnSkillName)
  await ensureDir(dir)
  await writeText(join(dir, "SKILL.md"), doc())
  return join(root, ".conductor", "skills")
}
